...
VOID Trace(TRACE trace, VOID *v) {
	...
	//std::cout<<"process:"<<procTreeNode->getProcIdx()<<std::endl;
    if (!procTreeNode->isInFastForward() || !zinfo->ffReinstrument) {
...
void SimThreadStart(THREADID tid) {
	...
	//std::cout<<"cid is:"<<getCid(tid)<<" pid is"<<procIdx<<std::endl;
	//(zinfo->cores[getCid(tid)])->SetPaging(zinfo->paging_array[procIdx]);
