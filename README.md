...
* gcc(>=4.6)
* Intel Pin Toolkit(Already integrates in project, or you can download from ) [pin-2.13-61206-gcc.4.4.7-linux](http://software.intel.com/sites/landingpage/pintool/downloads/pin-2.13-61206-gcc.4.4.7-linux)
